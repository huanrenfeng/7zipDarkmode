...
extern bool AllowDarkModeForWindow(HWND hWnd, bool allow);
extern bool IsHighContrast();
extern void RefreshTitleBarThemeColor(HWND hWnd);
extern bool IsColorSchemeChangeMessage(LPARAM lParam);
extern bool IsColorSchemeChangeMessage(UINT message, LPARAM lParam);
extern void AllowDarkModeForApp(bool allow);
extern void FixDarkScrollBar();
extern constexpr bool CheckBuildNumber(DWORD buildNumber);
extern void InitDarkMode();
#endif